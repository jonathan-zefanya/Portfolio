...
const TECH_STACK = ["Laravel", "CodeIgniter", "Node.js", "Flutter"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Jonathan-Zefanya" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/jonathan-natannael-zefanya-212b9b25a/" },
  { icon: Instagram, link: "https://www.instagram.com/xeadesta?igsh=YW1mbHJ0OGxlcGw=" }
];
...
const Home = () => {
  ...
  const lottieOptions = {
    src: "https://lottie.host/1c0f9b66-cb34-40c5-ae95-e392811ba8c9/GgVzwlswkY.lottie",
    loop: true,
    autoplay: true,
    rendererSettings: {
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Menciptakan Aplikasi Yang Inovatif, Fungsional, dan User-Friendly untuk Solusi Digital.
                </p>
