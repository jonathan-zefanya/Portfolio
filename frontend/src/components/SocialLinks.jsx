...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/jonathan-natannael-zefanya-212b9b25a/ ",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@xeadesta",
    icon: Instagram,
    url: "https://www.instagram.com/xeadesta?igsh=YW1mbHJ0OGxlcGw=",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@JonathanZefanya",
    icon: Youtube,
    url: "https://www.youtube.com/@jonathanzefanya",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@JonathanZefanya",
    icon: Github,
    url: "https://github.com/JonathanZefanya",
    color: "#ffffff",
